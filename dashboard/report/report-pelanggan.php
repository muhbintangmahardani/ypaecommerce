    ...
    <table border="1" style="border-collapse: collapse; width: 100%;" cellspacing="2">
        <thead>
            <tr>
                ...
                <th style="font-size: 12px; padding: 10px;">No Telpon</th>
                <th style="font-size: 12px; padding: 10px;">Alamat</th>
                <th style="font-size: 12px; padding: 10px;">Email</th>
            </tr>
        </thead>
        <tbody>
            <?php foreach ($result as $data) : ?>
                <tr>
                    ...
                    <td style="font-size: 12px; padding: 10px;"><?= $data['nama_lengkap'] ?></td>
                    <td style="font-size: 12px; padding: 10px;"><?= $data['no_telp'] ?></td>
                    <td style="font-size: 12px; padding: 10px;"><?= $data['alamat'] ?></td>
                    <td style="font-size: 12px; padding: 10px;"><?= $data['email'] ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
...
$mpdf->Output('report-pelanggan.pdf', 'D');
?>